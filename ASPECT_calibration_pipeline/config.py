...
# Project directory
project_directory: str = "/Users/valtterimj/Downloads/Work/Aalto/Hera/Pipeline/main/"

# INPUT path for the acquisition data
# input_directory: str = "/Users/valtterimj/Downloads/Work/Aalto/Hera/Pipeline/main/test_data/ASPECT_in-flight-dark_250225/acqseq_105"
input_directory: str = "/Users/valtterimj/Downloads/Work/Aalto/Hera/Pipeline/main/test_data/ASPECT_simulated_images/didy-noboulders-didysmoothed-10km"

# OUTPUT path where the results are saved
# output_directory: str = "/Users/valtterimj/Downloads/Work/Aalto/Hera/Pipeline/main/pipeline_results/ASPECT_in-flight-dark_20250225/acqseq_105"
output_directory: str = "/Users/valtterimj/Downloads/Work/Aalto/Hera/Pipeline/main/pipeline_results/ASPECT_simulated_images/didy-noboulders-didysmoothed-10km"
...
OSERV_ID:   str = 'Simulated_D1D2'                    # Hera observation ID                
...
calibration_directory = "/Users/valtterimj/Downloads/Work/Aalto/Hera/Pipeline/main/ASPECT_calibration_pipeline/calibration_data"

# Adjust these to point to the locations of spice metakernels
spice_mk_plan = "/Users/valtterimj/Downloads/Work/Aalto/Hera/hera_spice/kernels/mk/hera_plan.tm"
spice_mk_ops = "/Users/valtterimj/Downloads/Work/Aalto/Hera/hera_spice/kernels/mk/hera_ops.tm"
...
save_transformation_matrix = False # Save Vis-NIR alignemnt matrix
use_transformation_matrix = False # Use a previously calculated matrix to align Vis-NIR (if False the matrix is calculated)
trans_matrix_filename = 'D1D2-10km.fits' # if use_transformation_matrix is True set here the correct matrix file name.
...
_path_radiance = Path(project_directory) / subdirs['pipeline'] / subdirs['calibration'] / subdirs['radiance']
...
_path_sim_tans_matrix = Path(project_directory) / subdirs['pipeline'] / subdirs['calibration'] / subdirs['simulated'] / subdirs['trans_matrix']
